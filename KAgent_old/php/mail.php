...
$BccMail = "yoheykondo510@gmail.com,y_kondo@office-kagent.com";
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="http://office-kagent.com" target="_blank">- 株式会社ケージェント~KAgent.Inc -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
