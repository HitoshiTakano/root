...
$site_top = "http://worldgrow.jp";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "sales@worldgrow.jp";
...
$Referer_check_domain = "worldgrow.jp";
...
$require = array('会社・組織名','担当者・氏名','電話番号','Email','件名');
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="http://worldgrow.jp" target="_blank">- 株式会社World Grow - ワールドグロー -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
