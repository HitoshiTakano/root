...
$Referer_check_domain = "kagentk.com";
...
<input type="button" onclick="history.back()"><label for="submit">前の画面に戻る</label>
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="http://kagentk.com" target="_blank">- 株式会社 ＫＡｇｅｎｔ -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
