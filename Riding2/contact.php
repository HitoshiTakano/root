		...
		<section>
			...
			<div class="form">
				...
				<form action="<?php echo $url ?>" method="post" autocomplete="off">
					...
					<div><input type="text" name="name" id="name" placeholder="(必須) 株式会社Ｒｉｄｉｎｇ　久保田淳平" maxlength="30" value="<?php if(isset($post['name'])) echo $comm -> h($post['name']); ?>" required></div>
					...
					<div><input type="text" name="subject" id="subject" placeholder="(必須) パートナー契約依頼" maxlength="100" value="<?php if(isset($post['subject'])) echo $comm -> h($post['subject']); ?>" required></div>
